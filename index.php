<html>  
    <head>
        <title>Show records w/ajax and insert records on modal w/sp and ajax</title>
        <meta charset="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
        <meta name="author" content="Adhirsaurio" />
        <meta name="description" content="Show records w/ajax and insert records on modal w/sp and ajax" />
    ...
    <body class="d-flex flex-column min-vh-100">  
        ...
        <footer class="footer text-center mt-auto">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <p class="lead mb-0">Show records w/ajax and insert records on modal w/sp and ajax <a href="https://github.com/adhirsaurio?tab=repositories"><i class="fab fa-github-alt"></i></a></p>
                    </div>
                </div>
            </div>
        </footer>
